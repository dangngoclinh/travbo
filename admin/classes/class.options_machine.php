            ...
            if (!empty($smof_data) || !empty($data)) {
                ...
                switch ($value['type']) {
                    ...
                    case 'backup':
                        ...
                        $output .= '<p><strong>' . __('Last Backup : ', 'travbo') . '<span class="backup-log">' . $log . '</span></strong></p></div>' . "\n";
                    ...
                    case 'transfer':
                        ...
                        $instructions = $value['desc'];
                        $output .= '<textarea id="export_data" rows="8">' . of_encode(serialize($smof_data)) /* 100% safe - ignore theme check nag */ . '</textarea>' . "\n";
